    ...
    fun checkCollection(collectionList: ArrayList<Collection>): ArrayList<Collection> {
        ...
        for (i in 0 until 30) {
            ...
            when (i) {
                ...
                5 -> addCollection(collectionList, "광어", R.drawable.gawnga, "순우리말은 넙치다.\n우럭과 함께 한국을 대표하는 양대산맥 횟감이다.\n\n태평양 서부 지역에 주로 분포하며 모래 바닥을 선호한다.\n\n자연산 넙치는 배의 색깔이 하얗다.")
